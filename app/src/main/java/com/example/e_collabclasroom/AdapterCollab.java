...
public class AdapterCollab extends RecyclerView.Adapter<AdapterCollab.ListViewHolderCollabCollab> {
    private ArrayList<ModelCollab> modelCollab;

    public AdapterCollab(ArrayList<ModelCollab> list) {
    ...
    public void onBindViewHolder(@NonNull final ListViewHolderCollabCollab holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent  = new Intent(view.getContext(),WebViewCollab.class);
                intent.putExtra("link",hero.getTxtLink());
